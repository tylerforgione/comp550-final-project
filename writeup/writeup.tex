...
\end{equation}
with a 512-token limit. The retrieval corpus consisted of three MedRAG corpora: the medical textbooks corpora, the StatPearls corpora and a 150k sample of the Wikipedia corpus. All passages were chunked into 100-word segments and embedded with MedCPT \cite{Jin_2023}. Queries were encoded and matched via inner product to return the top three contexts.
